...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About Innstala Support'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://innstala.com/');
                  },
                  child: Text(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} Innstala\n$license',
                            style: const TextStyle(color: Colors.white),
                          ),
                          Text(
                            'Esta es una versión personalizada y optimizada por INNSTALA basada en el proyecto de código abierto RustDesk.',
                              style: TextStyle(
                                fontWeight: FontWeight.w800,
                                color: Colors.white.withOpacity(0.7), // Un pelín de transparencia para que quede elegante
                              ),
                          )
                        ],
                      ),
